...
![](./files/04%20-%20Cover%20All%20Your%20Bases/04%20-%20Cover%20All%20Your%20Bases.png)

---

Ten different sets of encoded data for ten different flags.
...
```
>>> print("".join([chr(int(o,2)) for o in flag.split(" ")]))
...
```
>>> print("".join([chr(int(o,8)) for o in flag.split(" ")]))
...
```
>>> print("".join([chr(int(o,10)) for o in flag.split(" ")]))
...
```
>>> print("".join([chr(int(o,16)) for o in flag.split(" ")]))
...
The line breaks invalidate the padding.

```
>>> print(base64.b32decode("".join(flag.split())))
b'Good work! That was Base 32, often used in Google Authenticator keys. It uses A-Z and 2-7. If you see lots of uppercase letters and digits, think Base32. Get that flag! flag{9bb5bb8ea508bcfbc51bd5e11efb29cc}'
```
...
I couldn't find a reliable Python example for decoding this without jumping through hoops, so I switched to [CyberChef](https://gchq.github.io/CyberChef/#recipe=From_Base45('0-9A-Z%20$%25*%2B%5C%5C-./:',true)&input=).
...
```
>>> print(base64.b64decode("".join(flag.strip().split())).decode())
...
Back to [CyberChef](https://gchq.github.io/CyberChef/#recipe=From_Base85('!-u',true,'z')&input=%2BPg) because Python doesn't like this variant.
...
Once again, [CyberChef](https://gchq.github.io/CyberChef/#recipe=From_Base92()&input=) to the rescue.
...
This was just a wild guess based on the characters being unicode in a high value range. I found an [online decoding tool](https://www.better-converter.com/Encoders-Decoders/Base65536-Decode) that worked.
